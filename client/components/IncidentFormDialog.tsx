...
export function IncidentFormDialog({
  ...
  const [formData, setFormData] = useState<IncidentFormData>({
    ...
    description: "",
    attachments: [],
    reporterName: "Shivam Shivam", // Retrieved from user context
    reporterEmail: "shivam@zsassociates.com", // Retrieved from user context
  });
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          description: "",
          attachments: [],
          reporterName: "Shivam Shivam",
          reporterEmail: "shivam@zsassociates.com",
        });
        onOpenChange(false);
      } else {
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <div className="space-y-1 text-xs text-blue-700">
                  ...
                  <p>📧 Critical Support: critical@zsassociates.com</p>
