          ...
          <div className="flex items-center justify-between">
              ...
              <div>
                <DialogTitle className="text-2xl font-bold text-gray-900 flex items-center space-x-3">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Badge variant="outline" className={`${getStatusColor(agent.status)} text-sm font-medium`}>
            ...
            <div className="flex items-center space-x-6 text-sm">
              <div className="text-center">
                ...
                <div className="font-bold text-gray-900">{agent.performance.successRate}%</div>
              ...
              <div className="text-center">
                ...
                <div className="font-bold text-gray-900">{agent.performance.responseTime}ms</div>
              ...
              <div className="text-center">
                ...
                <div className="font-bold text-gray-900">${agent.sessions.costPerSession.toFixed(3)}</div>
              ...
              <div className="text-center">
                ...
                <div className="font-bold text-gray-900">{(agent.tokens.total / 1000).toFixed(0)}K</div>
