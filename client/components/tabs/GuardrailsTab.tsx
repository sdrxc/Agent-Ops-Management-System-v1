...
const mockRecommendations: Recommendation[] = [
  {
    ...
    description: 'Based on your agent\'s interaction patterns, we recommend enabling violence detection filters to improve safety.',
  ...
  },
  {
    ...
    description: 'Your agent handles user data. Implementing additional GDPR controls would improve compliance.',
  ...
  },
  {
    ...
    description: 'Current content filters add 45ms latency. Consider optimizing filter order for better performance.',
...
export function GuardrailsTab({ agent }: GuardrailsTabProps) {
  ...
  const toggleGuardrail = (id: string) => {
    setGuardrails(guardrails.map(rule => 
              ...
              <Card>
                <CardContent className="p-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <div className="text-2xl font-bold">{guardrails.filter(g => g.enabled).length}</div>
              ...
              <Card>
                <CardContent className="p-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <div className="text-2xl font-bold">{guardrails.reduce((sum, g) => sum + g.detections, 0)}</div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <div className="text-2xl font-bold">
                        {(guardrails.reduce((sum, g) => sum + g.accuracy, 0) / guardrails.length).toFixed(1)}%
                      </div>
              ...
              <Card>
                <CardContent className="p-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <div className="text-2xl font-bold">{guardrails.reduce((sum, g) => sum + g.falsePositives, 0)}</div>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-4 text-sm">
                          <span className="text-gray-500">
                            Detections: <span className="font-medium">{rule.detections}</span>
                          </span>
                          <span className="text-gray-500">
                            Accuracy: <span className="font-medium">{rule.accuracy}%</span>
                          </span>
                          <span className="text-gray-500">
                            False Positives: <span className="font-medium">{rule.falsePositives}</span>
                          </span>
                        </div>
                      </div>
                ...
                <div className="space-y-4">
                  {recommendations.map((rec) => (
                    <div key={rec.id} className="border rounded-lg p-4">
                      ...
                      <p className="text-sm text-green-600 font-medium mb-3">Impact: {rec.impact}</p>
          ...
          <TabsContent value="monitoring" className="space-y-6">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="text-center">
                      <div className="text-3xl font-bold text-green-600">Low Risk</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {[
                    { time: '2 minutes ago', event: 'PII detection blocked sensitive data exposure', severity: 'high' },
                    { time: '15 minutes ago', event: 'Content filter flagged potentially toxic response', severity: 'medium' },
                    { time: '1 hour ago', event: 'Prompt injection attempt detected and blocked', severity: 'critical' },
                    { time: '3 hours ago', event: 'Routine security scan completed successfully', severity: 'low' }
                  ].map((event, index) => (
